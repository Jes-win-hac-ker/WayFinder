    ...
    <main className={styles.shell}>
      ...
      <section className={styles.content} id="overview">
        ...
        {isTrustedViewer && sharedJourney && (
          <div className={`${styles.sharedBanner} ${isDuress ? styles.emergencyBanner : ""}`}>
            <span>{isDuress ? "EMERGENCY! The traveler has activated the silent SOS duress protocol." : "Shared journey · Syncing every 5s"}</span>
            {isDuress && (
              <a href="tel:100" className={styles.emergencyButton}>
