      ...
      <section className={styles.content} id="overview">
        ...
        {isTrustedViewer && sharedJourney && (
          <div className={styles.sharedBanner} style={isDuress ? { backgroundColor: "#c0392b", color: "#fff", fontWeight: "bold", display: "flex", flexDirection: "column", gap: "8px" } : {}}>
            ...
            {isDuress && (
              <a href="tel:100" style={{ backgroundColor: "#fff", color: "#c0392b", padding: "8px 12px", borderRadius: "6px", textDecoration: "none", textAlign: "center", textTransform: "uppercase", letterSpacing: "0.5px" }}>
